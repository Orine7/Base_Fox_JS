...
function withNx(nextConfig = {}) {
    ...
    return Object.assign(Object.assign({ eslint: Object.assign({ ignoreDuringBuilds: true }, ((_a = nextConfig.eslint) !== null && _a !== void 0 ? _a : {})) }, nextConfig), { webpack: (config, options) => {
            /*
